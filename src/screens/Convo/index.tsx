...
import { INITIATE_CONVERSATION, JoinRoomMutation, PAIR_MATCHES, roomConnectingToOtherMutation } from '../../graphql/mutations';
import Toast from 'react-native-toast-message';
import AsyncStorage from '@react-native-async-storage/async-storage';

const Convo = ({ navigation, colors }: { navigation: any; colors: any }) => {
  const client = useApolloClient();
  // const username = AsyncStorage.getItem('mobileNumber');
